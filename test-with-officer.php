...
/**
 * Test Stripe Controller with Valid Officer ID
 */

echo "🧪 Testing Stripe Controller with Officer ID\n";
echo "==========================================\n\n";

$baseUrl = 'http://127.0.0.1:8000/api';

// Test data with valid officer_id
$testData = [
    'tax_payee_id' => 1,
    'tax_property_id' => 1,
    'tax_assessment_id' => 1,
    ...
    'pay_date' => '2025-09-29',
    'currency' => 'lkr',
    'officer_id' => 1, // Try with officer_id = 1
